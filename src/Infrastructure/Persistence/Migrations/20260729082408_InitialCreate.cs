        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    // xmin is Postgres's built-in system column on every table — never
                    // created via DDL (attempting to would fail: "column name xmin
                    // conflicts with a system column name"). EF Core still tracks it as
                    // a mapped shadow property for optimistic concurrency (see
                    // RefreshTokenConfiguration.UseXminAsConcurrencyToken()); this line
                    // is manually removed from what the scaffolder generates.
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), true, "Default" });
